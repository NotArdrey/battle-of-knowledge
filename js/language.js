...
const translations = {
    en: {
        ...
        'skipLearning': 'Skip Learning (Not Recommended)',
        ...
        // Era Descriptions
        'eraDesc_earlySpanish': 'Experience the dawn of Spanish colonization. Witness the epic Battle of Mactan where Lapu-Lapu\'s forces defeated Magellan\'s expedition.',
        'eraDesc_lateSpanish': 'Join the Philippine Revolution! Fight alongside heroes like Andres Bonifacio and Jose Rizal in the struggle against 333 years of Spanish rule.',
        'eraDesc_american': 'Enter the Philippine-American War. Experience the resistance against American colonization and the fight for true independence.',
        'eraDesc_ww2': 'Survive World War II in the Pacific! Battle through Japanese occupation, guerrilla warfare, and the fight to liberate the Philippines.'
    },
    tl: {
        // Index page
        ...
        'skipLearning': 'Laktawan ang Pag-aaral (Hindi Inirerekomenda)',
        ...
        // Era Descriptions
        'eraDesc_earlySpanish': 'Maranasan ang bukang-liwayway ng kolonisasyon ng Espanya. Saksihan ang epikong Labanan sa Mactan kung saan tinalo ng puwersa ni Lapu-Lapu ang ekspedisyon ni Magellan.',
        'eraDesc_lateSpanish': 'Sumali sa Rebolusyong Pilipino! Lumaban kasama sina Andres Bonifacio at Jose Rizal sa pakikibaka laban sa 333 taon ng pamumuno ng Espanya.',
        'eraDesc_american': 'Pumasok sa Digmaang Pilipino-Amerikano. Damhin ang paglaban sa kolonisasyon ng mga Amerikano at ang pakikipaglaban para sa tunay na kalayaan.',
        'eraDesc_ww2': 'Mabuhay sa Ikalawang Digmaang Pandaigdig sa Pasipiko! Lumaban sa pananakop ng Hapon, pakikipaglaban ng gerilya, at ang laban para palayain ang Pilipinas.'
    }
};
